...
<h3>Generate &quot;Counting-By&quot; Or Counting Tables</h3>
        <s:form name="CountingTables" action="ActionSupportCountingTables" method="get">
            ...
            <s:radio id="radio1" label="Counting-by" name="ctModel.countBy" list="#{ 'one' : '1', 'two' : '2' : 'five' : '5' }" value="one" />
            ...
            <s:radio id="radio2" label="Counting uptil" name="ctModel.countUptil" list="#{ '1hundred' : '100', '2hundred' : '200' }" value="1hundred" />
